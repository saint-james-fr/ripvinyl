...
class ReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create release" do
    assert_difference("Release.count") do
      post releases_url, params: { release: { data: @release.data, ripped: @release.ripped, user_id: @release.user_id } }
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { data: @release.data, ripped: @release.ripped, user_id: @release.user_id } }
